...
const Answer_form_A: React.FC<Props> = ({videoLengthMismatch,freeTextAnswer1, freeTextAnswer2, setFreeTextAnswer1, setFreeTextAnswer2, postFreetextAnswerToServer, submitFreeTextToServer}: Props) => {
